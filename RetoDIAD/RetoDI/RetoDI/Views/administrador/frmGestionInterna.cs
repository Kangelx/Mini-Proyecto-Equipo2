...
namespace RetoDI
{
    public partial class frmGestionInterna : Form
    {
        ...
        {
            this.Close();
            frmBotones botones = new frmBotones();
            botones.Show();
        }
        ...
        {
            lblUsuario.Text = $"Bienvenido {SessionData.NombreProfesor} {SessionData.ApellidosProfesor}";
        }


        private void frmGestionInterna_Load(object sender, EventArgs e)
        {
